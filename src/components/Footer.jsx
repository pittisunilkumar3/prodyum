        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/projects" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/investors" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm">
                  Investors
                </Link>
              </li>
              <li>
                <Link to="/casting" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm">
                  Casting & Crew
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+919949590033" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm">
                  +91 99495 90033
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-amber-500 flex-shrink-0" />
                <a href="mailto:entertainment@prodyum.in" className="text-gray-400 hover:text-amber-500 transition-colors duration-300 text-sm break-all">
        ...
        <div className="mt-16 pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <Link to="/" className="text-gray-500 hover:text-amber-500 transition-colors duration-300 text-sm">
                Privacy Policy
              </Link>
              <Link to="/" className="text-gray-500 hover:text-amber-500 transition-colors duration-300 text-sm">
                Terms of Service
