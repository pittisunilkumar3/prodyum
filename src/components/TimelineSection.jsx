    ...
    <section className="py-32 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <span className="text-prodyum-blue-500 text-sm font-semibold uppercase tracking-wider">Our Journey</span>
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-prodyum-blue-500 via-prodyum-blue-500/50 to-transparent" />
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="flex-1 w-full">
                  <Card className="bg-neutral-900 border-white/10 hover:border-prodyum-blue-500/50 transition-all duration-500 group overflow-hidden">
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                      <div className="relative overflow-hidden aspect-video sm:aspect-square">
                        ...
                        <div className="absolute top-6 left-6">
                          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-prodyum-blue-500/20 backdrop-blur-sm border border-prodyum-blue-500/50">
                            <milestone.icon className="h-8 w-8 text-prodyum-blue-500" />
                          </div>
                        </div>
                      </div>
                      <CardContent className="p-8 flex flex-col justify-center">
                        <div className="text-6xl font-bold text-prodyum-blue-500/20 mb-4">{milestone.year}</div>
                        <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-prodyum-blue-500 transition-colors duration-300">
                          {milestone.title}
                        </h3>
                ...
                <div className="hidden lg:flex items-center justify-center flex-shrink-0">
                  <div className="w-6 h-6 rounded-full bg-prodyum-blue-500 border-4 border-black shadow-lg shadow-prodyum-blue-500/50" />
                </div>
