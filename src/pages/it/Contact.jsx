              ...
              <div className="bg-gray-900/50 border border-white/10 rounded-3xl p-8 md:p-10">
                ...
                {isSubmitted && (
                  <div className="mb-8 p-6 bg-prodyum-green-500/10 border border-prodyum-green-500/20 rounded-2xl flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-prodyum-green-400 mb-1">Message Sent Successfully!</h4>
                ...
                {error && (
                  <div className="mb-8 p-6 bg-prodyum-blue-500/10 border border-prodyum-blue-500/20 rounded-2xl flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-prodyum-blue-400 mb-1">Email Client Opened</h4>
