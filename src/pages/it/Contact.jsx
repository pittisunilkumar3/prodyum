...
const ITContact = () => {
  ...
  const socials = [
    { icon: Linkedin, href: 'https://linkedin.com', color: 'hover:bg-prodyum-blue-600' },
    { icon: Twitter, href: 'https://twitter.com', color: 'hover:bg-prodyum-green-600' },
    { icon: Instagram, href: 'https://instagram.com', color: 'hover:bg-prodyum-lime-600' },
    { icon: Facebook, href: 'https://facebook.com', color: 'hover:bg-prodyum-blue-700' },
  ];
                  ...
                  <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                      <div>
                        <label htmlFor="name" className="mb-2 block text-sm font-medium text-gray-300">
                          Full Name <span className="text-prodyum-blue-500">*</span>
                        </label>
                        <input
                          type="text"
                          id="name"
                      ...
                      <div>
                        <label htmlFor="email" className="mb-2 block text-sm font-medium text-gray-300">
                          Email Address <span className="text-prodyum-blue-500">*</span>
                        </label>
                        <input
                          type="email"
                          id="email"
                    ...
                    <div>
                      <label htmlFor="message" className="mb-2 block text-sm font-medium text-gray-300">
                        Message <span className="text-prodyum-blue-500">*</span>
                      </label>
                      <textarea
                        id="message"
                        name="message"
