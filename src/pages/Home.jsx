        ...
        <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            >
              ...
              >
                <a href="/entertainment#investors">
                  ...
                  <div className="p-8 space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-prodyum-blue-500/20 via-prodyum-green-500/20 to-prodyum-lime-500/20 rounded-xl p-8 border border-white/10 text-center">
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        >
                          <a href="/entertainment#investors">Investor Information</a>
                        </Button>
                        <Button
                          asChild
                          size="lg"
                        ...
                        >
                          <a href="/entertainment#contact">Contact Us</a>
                        </Button>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              >
                <a href="/entertainment#casting">Apply: Cast & Crew</a>
              </Button>
            </div>
          </div>
        </div>
